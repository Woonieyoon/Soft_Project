...
public class ClubInsertActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title = (EditText)findViewById(R.id.club_write_title);
        contents = (EditText)findViewById(R.id.club_write_content);
        save = (Button)findViewById(R.id.club_saveBtn);
        cancel = (Button)findViewById(R.id.club_cancelBtn);
        ...
        save.setOnClickListener(new View.OnClickListener() {  //저장 버튼
            ...
            public void onClick(View v) {
                ...
                ClubInsertActivity.InsertTask c = new ClubInsertActivity.InsertTask(ClubInsertActivity.this);
    ...
    class InsertTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            {
                Intent next = new Intent(ClubInsertActivity.this,ClubMainActivity.class);
                startActivity(next);
            }else
            {
                result = "다시 입력하세요";
        ...
        protected String doInBackground(String... params) {
            ...
            String login_url = "http://" + Basicinfo.URL + "/clubcontent.php";
