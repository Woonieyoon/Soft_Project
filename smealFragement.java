 ...
 */
//상주 식단
public class smealFragement extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.smeal, container, false);
        tx1 = (TextView)v.findViewById(R.id.text1);
        tx2 = (TextView)v.findViewById(R.id.text2);
        tx3= (TextView)v.findViewById(R.id.text3);
        new BackgroudTask1().execute();
